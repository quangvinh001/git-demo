...
{
echo '<script language="javascript">alert("Bị trùng tên hoặc chưa nhập tên!"); window.location="http://localhost:8080/quanlynhahang/admin/view/mathang/danhmuc.php";</script>';
